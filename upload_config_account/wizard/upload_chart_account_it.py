...
class UploadChartAccountIt(models.TransientModel):
	...
	def upload_chart_tax(self):
		...
		obj.create({
			...
			'tax_group_id': self.env['account.tax.group'].search([('name','=','IGV'),('company_id','=',self.env.company.id)], limit=1).id,
		...
		obj.create({
			...
			'price_include':False,
			'include_base_amount':False,
			'tax_group_id': self.env['account.tax.group'].search([('name','=','IGV GyNG'),('company_id','=',self.env.company.id)], limit=1).id,
			'tax_exigibility':'on_invoice',
			'invoice_repartition_line_ids': [
				(0, 0, { 'repartition_type': 'base', 
						'factor_percent': 100.0,
		...
		obj.create({
			...
			'price_include':False,
			'include_base_amount':False,
			'tax_group_id': self.env['account.tax.group'].search([('name','=','IGV NG'),('company_id','=',self.env.company.id)], limit=1).id,
			'tax_exigibility':'on_invoice',
			'invoice_repartition_line_ids': [
				(0, 0, { 'repartition_type': 'base', 
						'factor_percent': 100.0,
		...
		obj.create({
			...
			'price_include':False,
			'include_base_amount':False,
			'tax_group_id': self.env['account.tax.group'].search([('name','=','INA'),('company_id','=',self.env.company.id)], limit=1).id,
			'tax_exigibility':'on_invoice',
			'invoice_repartition_line_ids': [
				(0, 0, { 'repartition_type': 'base', 
						'factor_percent': 100.0,
		...
		obj.create({
			...
			'price_include':False,
			'include_base_amount':False,
			'tax_group_id': self.env['account.tax.group'].search([('name','=','OTROS'),('company_id','=',self.env.company.id)], limit=1).id,
			'tax_exigibility':'on_invoice',
			'invoice_repartition_line_ids': [
				(0, 0, { 'repartition_type': 'base', 
						'factor_percent': 100.0,
		...
		obj.create({
			...
			'price_include':False,
			'include_base_amount':False,
			'tax_group_id': self.env['account.tax.group'].search([('name','=','EXO'),('company_id','=',self.env.company.id)], limit=1).id,
			'tax_exigibility':'on_invoice',
			'invoice_repartition_line_ids': [
				(0, 0, { 'repartition_type': 'base', 
						'factor_percent': 100.0,
		...
		obj.create({
			...
			'price_include':False,
			'include_base_amount':False,
			'tax_group_id': self.env['account.tax.group'].search([('name','=','EXP'),('company_id','=',self.env.company.id)], limit=1).id,
			'tax_exigibility':'on_invoice',
			'invoice_repartition_line_ids': [
				(0, 0, { 'repartition_type': 'base', 
						'factor_percent': 100.0,
		...
		obj.create({
			...
			'price_include':False,
			'include_base_amount':False,
			'tax_group_id': self.env['account.tax.group'].search([('name','=','ICBPER'),('company_id','=',self.env.company.id)], limit=1).id,
			'tax_exigibility':'on_invoice',
			'invoice_repartition_line_ids': [
				(0, 0, { 'repartition_type': 'base',
						'factor_percent': 100.0,
