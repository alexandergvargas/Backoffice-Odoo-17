	...
	def get_excel_f2_register(self):
		...
		for c,line in enumerate(res):
			...
			if self.show_account_entries:
				...
				worksheet.write(x,16,line['group_balance'] if line['group_balance'] else '',formats['especial1'])
				worksheet.write(x,17,line['group_nature'] if line['group_nature'] else '',formats['especial1'])
				worksheet.write(x,18,line['group_function'] if line['group_function'] else '',formats['especial1'])
			x += 1
