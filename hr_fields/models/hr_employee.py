...
class HrEmployee(models.Model):
	...
	private_street = fields.Char(string=u'Domicilio')
	user_partner_id = fields.Many2one(related='user_id.partner_id', related_sudo=False, string="Contacto Asociado", store=True)

	employee_type = fields.Selection(required=False)
