...
class AccountCashFlowBookAdvanceProjected(models.Model):
	_name = 'account.cash.flow.book.advance.projected'
	_description = 'Account Cash Flow Book Advance Projected'
