...
class CustomerInvoicesPendingReconciliationWizard(models.TransientModel):
	_name = 'customer.invoices.pending.reconciliation.wizard'
	...
	def get_report(self):
		...
		if self.type_show == 'pantalla':
			...
			return {
				'name': 'Facturas de Cliente pendientes de conciliar',
	...
	def get_excel(self):
		...
		return self.env['popup.it'].get_file('Facturas de Cliente pendientes de conciliar.xlsx',workbook)
