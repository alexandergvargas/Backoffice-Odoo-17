...
class AccountMoveTemplateLine(models.Model):
	...
	template_id = fields.Many2one(
		"account.move.template", string="Plantilla del Asiento", ondelete="cascade"
	)
	...
	move_line_type = fields.Selection(
		[("cr", "Credito"), ("dr", "Debito")], required=True, string=u"Dirección"
	)
	...
	def _onchange_type(self):
		for i in self:
			i.nro_comp = i.template_id.nro_comp
			i.type_document_id = i.template_id.type_document_id
