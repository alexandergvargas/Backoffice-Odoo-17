...
class AccountMove(models.Model):
	...
	def write(self, vals):
		res = True
		for move in self:
			if 'access_token' in vals or 'amount_untaxed' in vals or 'amount_tax' in vals or 'amount_total' in vals or 'amount_residual' in vals or 'amount_untaxed_signed' in vals or 'amount_tax_signed' in vals or 'amount_total_signed' in vals or 'amount_residual_signed' in vals or 'payment_state' in vals or 'needed_terms_dirty' in vals:
...
class AccountMoveLine(models.Model):
	...
	def write(self, vals):
		result = True
		for line in self:
			if 'full_reconcile_id' in vals or 'reconciled' in vals or 'amount_residual' in vals or 'amount_residual_currency' in vals or 'matching_number' in vals or 'discount_allocation_dirty' in vals or 'balance' in vals or 'compute_all_tax_dirty' in vals or 'epd_dirty' in vals:
