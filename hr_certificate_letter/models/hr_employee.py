...
class certificate(models.TransientModel):
    ...
    def export_certificate(self):
        ...
        return self.env.ref('hr_certificate_letter.action_report_certificate').report_action(self)
...
class letter(models.TransientModel):
    ...
    def export_letter(self):
        ...
        if self.date_fin == False:
            raise ValidationError('Ingrese Fecha Final')
        return self.env.ref('hr_certificate_letter.action_report_letter').report_action(self)
