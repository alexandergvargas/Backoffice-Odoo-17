...
Many2OneAvatarResourceField.template = "hr_assistance_planning.Many2OneAvatarResourceField";
...
export class KanbanMany2OneAvatarResourceField extends Many2OneAvatarResourceField {
    static template = "hr_assistance_planning.KanbanMany2OneAvatarResourceField";
}
