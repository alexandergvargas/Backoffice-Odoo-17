...
export class PlanningGanttRenderer extends GanttRenderer {
    ...
    async onWillStart() {
        this.isPlanningManager = await this.userService.hasGroup('hr_attendance.group_hr_attendance_manager');
    }
...
PlanningGanttRenderer.rowHeaderTemplate = "hr_assistance_planning.PlanningGanttRenderer.RowHeader";
PlanningGanttRenderer.pillTemplate = "hr_assistance_planning.PlanningGanttRenderer.Pill";
