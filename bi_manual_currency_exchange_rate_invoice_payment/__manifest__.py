...
# Part of BrowseInfo. See LICENSE file for full copyright and licensing details.
{
    ...
    "version" : "17.0.0.1",
    "depends" : ['base','account','account_fields_it','compute_payments_widget_to_reconcile_info'],
    "author": "BrowseInfo, ITGRUPO, Glenda Julia Merma Mayhua",
    "summary": "Apps apply manual currency rate on invoice apply manual currency rate on payment apply custom currency rate on invoice custom currency rate on payment custom Currency Exchange Rate on Invoice custom Currency Exchange Rate on payment custom accounting rate - Obligatorio",
    "description": """
