...
class AccountDesConsistencyRep(models.TransientModel):
	...
	def get_sql(self):
		sql = """
				...
				left join (
				select a1.move_line_id,a2.account_id,a2.debit,a2.credit,a4.a_debit,a4.a_credit from account_analytic_line a1
				...
				where a3.check_moorage=TRUE) d2 on d2.move_line_id=d1.move_line_id
