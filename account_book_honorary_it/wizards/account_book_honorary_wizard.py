...
class AccountBookHonoraryWizard(models.TransientModel):
	...
	def get_excel(self):
		...
		for line in res:
			...
			worksheet.write(x,3,line['fecha_e'] if line['fecha_e'] else '',formats['reverse_dateformat'])
			worksheet.write(x,4,line['fecha_p'] if line['fecha_p'] else '',formats['reverse_dateformat'])
