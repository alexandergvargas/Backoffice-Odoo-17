...
class HrMainParameter(models.Model):
	...
	rule_total_income = fields.Many2one('hr.salary.rule', string='R. S. Rem. Afecta Utilidades')
	wd_dtrab = fields.Many2many('hr.work.entry.type', 'wd_dtrab_main_parameter_rel', 'main_parameter_id', 'wd_id', string='Worked Days Dias Trabajados')
	wd_falt = fields.Many2many('hr.work.entry.type', 'wd_falt_main_parameter_rel', 'main_parameter_id', 'wd_id', string='Worked Days Faltas')
