...
class RenderMainParameter(models.Model):
	...
	invoice_surrender_journal_id = fields.Many2one('account.journal',string=u'Diario para compras pagadas con rendiciones y reembolsos')
	invoice_petty_cash_journal_id = fields.Many2one('account.journal',string=u'Diario para compras pagadas con caja chica')
